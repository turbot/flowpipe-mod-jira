...
Run pipelines and use triggers for Jira resources.
...
- Pass in a value on the command line:
  ...
  ```shell
  flowpipe pipeline run list_issues --pipeline-arg token="ATATT..."
  ```
...
- [Jira Mod](https://github.com/turbot/flowpipe-mod-github/labels/help%20wanted)
